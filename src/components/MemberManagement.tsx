...
export function MemberManagement({ album, onUpdate }: MemberManagementProps) {
  ...
  const getRoleIcon = (role: string) => {
    switch (role) {
      ...
      case 'contributor':
        return <Edit3 className='w-3 h-3 text-green-500' />
      case 'viewer':
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to remove this member from the album? They
              will lose access to all content.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
